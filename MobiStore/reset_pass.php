			...
			<div class="login-box">
				...
				<form action="php/send_key_for_reset.php" method="post">
                    ...
                    <div class="input_box">
						...
						<input type="password" placeholder = "Նոր գաղտնաբառ" maxlength="22" name="password" >
					</div>
                    <div class="input_box">
						<i class="fa fa-lock"></i>
						<input type="password" placeholder="Կրկնեք Գաղտնաբառը" maxlength="22" name="cpassword" >
					</div>
					<input type="submit" name = "reset" class="btn" value="Հաստատել">
					<?php
						if(@$_SESSION['message']) {
